...
app.use(
      cors({
        origin: ['http://localhost:3000', 'https://project-3-client.vercel.app/', 'https://project-3-client-git-development-lschmidtfellner.vercel.app/', 'https://project-3-client-jexll19se-lschmidtfellner.vercel.app/'],
        credentials: true,
        methods: ["GET", "POST", "PUT", "PATCH", "DELETE"],
        exposedHeaders: ['Access-Control-Allow-Origin'],
      }))
